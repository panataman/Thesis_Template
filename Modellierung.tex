...
\begin{description}
	...
	\begin{description}
		\item[energy\_consumption\_day] Bei der Simulation einer
		Schar baugleicher K\"alteanlagen mit identischer
		Bef\"ullung und K\"uhlstrategie wird der durchschnittliche
		elektrische Energieverbrauch mit der Anzahl der K\"alteanlagen
		skaliert\todo{das ist noch zu \"uberpr\"ufen}.
		\item[averaged\_transmission\_losses] Summe aller gemittelten
		Transmissionsverluste (\cref{aptrans}).
		\item[m\_heat\_transmission\_coefficient]
	\end{description}


	\item[sum\_mass\_times\_capacity()] Berechnung die Summe der
	...
	% \end{equation}
	% \begin{description}
	% 	\item[N] Anza\hl der Substanzmassen mit unterschiedlicher
