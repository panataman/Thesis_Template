...
\begin{description}
	...
	Transmissionsverluste im Normalbetrieb (vgl. \cref{aptrans}).
	...
	f\"ur die Durchgagnsfl\"achen (vgl. \cref{vmod}).
	...
	nach einer Auswahl zwischen \cref{pmehr} und der \cref{lverd} bis
...
\begin{description}
	...
	\begin{description}
		...
		die Durchgagnsfl\"achen (vgl. \cref{vmod}).
		...
		Einfl\"usse. Die Berechnung erfolgt wie in der \cref{lverd} bis
		\cref{spmehr} beschrieben.
	\end{description}
