...
Die Implementierung des Kooperationskonzeptetes erfordert eine neue Klasse
\textbf{Cooling\_strategy}. Diese Klasse hat die Aufgabe jeder K\"uhlstelle in
jedem Supermarkt im Netz die aufgrund des  Kooperationskonzeptetes und der
...
\caption{Sequenzdiagramm Kooperationsstrategie}
	\label{fig:uml_coop}
	\begin{center}
		\includegraphics[scale=1]{images/Theorie_Super/sequence_two}
	\end{center}
\end{figure}
