...
durchgegangen worden sind, Punkt für Punkt beschrieben\todo{Grobentwurf
einbinden}.

\section{Aufgabenstellung}

Ein Programm zur Simulation des variablen Lastverhaltens von Kältelast mit
Kältespeicher im Energieversorgungsnetz\todo{Aufgabenstellung richtig
beschreiben}.
...
Die Intention der Arbeit, ein Programm zur Simulation des variablen
...
darauf abfällt \cite{doctor}\todo{freaky}. Der durchschnittliche
