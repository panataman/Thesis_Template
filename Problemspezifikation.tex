...
wird die Umsetzung der Implementierung vorgestellt\todo{Was ist los?}.
...
OOP\abvz{OOP}{objektorientierte Programmierung}: Lösung von Problemen durch ein
...
erweiterbar, besser testbar} und \textit{besser wartbar} sind\todo{SIND, das ist
hier nicht gut.}. Dabei wird ein Verfahren angewendet, nach dem große Systeme in
...
objektorientierten Software\todo{Was ist hier mit dem Komma?},
...
\cite{python}.}\todo{Das ist nicht ganz ok?}.
