...
\contentsline {lstlisting}{\numberline {3.1}config\_grid.m}{31}{lstlisting.3.1}
\contentsline {lstlisting}{\numberline {3.2}config\_supermarkets.m}{32}{lstlisting.3.2}
\contentsline {lstlisting}{\numberline {3.3}config\_fridges.m}{32}{lstlisting.3.3}
\contentsline {lstlisting}{\numberline {A.1}config\_grid.m}{44}{lstlisting.A.1}
\contentsline {lstlisting}{\numberline {A.2}config\_supermarkets.m}{44}{lstlisting.A.2}
\contentsline {lstlisting}{\numberline {A.3}config\_fridges.m}{44}{lstlisting.A.3}
\contentsline {lstlisting}{\numberline {A.4}runCooling.m}{46}{lstlisting.A.4}
